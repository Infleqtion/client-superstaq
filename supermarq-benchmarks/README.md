...
The [Supermarq tutorial](https://superstaq.readthedocs.io/en/latest/apps/supermarq/examples/examples.html) notebooks contain an end-to-end example of how to execute the GHZ benchmark
