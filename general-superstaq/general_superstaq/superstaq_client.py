...
class _SuperstaQClient:
    ...
    def aqt_compile(self, json_dict: Dict[str, Any]) -> Dict[str, str]:
    ...
    def qscout_compile(self, json_dict: Dict[str, Any]) -> Dict[str, Union[str, List[str]]]:
