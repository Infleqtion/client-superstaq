...
We will discuss how to set up and run Superstaq's AQT compiler with either Cirq or Qiskit, with examples of some of the Superstaq's unique tools and techniques for compiling and optimizing circuits for AQT with different hardware configurations. Some of the strategies demonstrated include:
