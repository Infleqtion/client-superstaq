...
def test_read_json_qubo_result() -> None:
    example_solution = np.rec.array([({0: 0, 1: 1, 3: 1}, -1, 6), ({0: 1, 1: 1, 3: 1}, -1, 4)], dtype=[('solution', 'O'), ('energy', '<f8'), ('num_occurrences', '<i8')])
    json_dict = {
...
def test_convert_qubo_to_model() -> None:
    ...
    qubo_model = [{'keys': ['0'], 'value': 1.0}, {'keys': ['1'], 'value': 1.0}, {'keys': ['0', '1'], 'value': -2.0}]
