...
class JobV3:
    ...
    def _wait_for_terminal_state(
        self, index: int | None, timeout_seconds: float | None = None, polling_seconds: float = 5
    ) -> None:
    ...
    def counts(
        ...
        """
        self._wait_for_terminal_state(index, timeout_seconds, polling_seconds)
